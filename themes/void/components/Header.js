  ...
  return (
    <div id='top-nav' className='z-40'>
      ...
      <div
        ...
        className={
          'top-0 duration-300 transition-all shadow-none fixed bg-black/50 dark:bg-black/80 dark:text-gray-200 text-white w-full z-20 transform border-b border-[#333]'
        }>
